...
const longestString = (arr) => {
  // Solution code here...
  let max = "";
  arr.map((Element) => (Element.length > max.length ? (max = Element) : ""));
...
const firstLetters = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.map((Element) => newArray.push(Element[0]));
  return newArray;
};
...
const findHappiness = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.map((Element) => Element.includes(":)") && newArray.push(Element));
  return newArray;
};
...
const onlyOddChars = (str) => {
  ...
  let newArray=[...str]
  let stri=[]
  newArray.map(Element=>newArray.indexOf(Element)%2===1&&stri.push(Element))
  return(stri.join(''));
};
...
const allHappy = (arr) => {
  // Solution code here...
  let newArray = []
  arr.map(Element=>newArray.push(Element.includes(':)')))
